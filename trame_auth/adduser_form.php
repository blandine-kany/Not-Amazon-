...
<!--    <h1>Inscription</h1>-->
    <form method="post">
        ...
        <table>
                    ...
                    <tr>
                        <td>
                            <label for="inputRole" class="control-label">vendeur:</label> 
                            <input type='radio' name="role" class="form-control" required value="Vendeur">
                        </td>
                        
                        <td>
                            <label for="inputRole" class="control-label">acheteur: </label>
                            <input type='radio' name="role" class="form-control" required value="Acheteur">
                        </td>
                    </tr>
